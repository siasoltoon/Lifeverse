...
Relational DB is authoritative; cache is non-authoritative. Queue/scheduler adapters invoke application use cases and must be idempotent, retryable and recoverable.
